...
| `@imposia/viewer` | Present committed pages | `mountPageViewer`, deep-link helpers |
...
<Cards>
  ...
  <Card title="Viewer API" href="/en/docs/api/viewer">
    Page presentation, Reader, and Inspector.
  </Card>
</Cards>
