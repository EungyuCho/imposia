---
title: Viewer API
description: Page presentation, Reader, and Inspector controllers from @imposia/viewer.
---

`@imposia/viewer` presents documents. `mountPageViewer` presents the canonical iframe of a committed Core page document. It does not run pagination.
