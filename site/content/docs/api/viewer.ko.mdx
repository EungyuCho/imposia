---
title: Viewer API
description: "@imposia/viewer가 제공하는 페이지 표시, Reader, Inspector 컨트롤러입니다."
---

`@imposia/viewer`는 문서를 표시합니다. `mountPageViewer`는 확정된 Core 페이지 문서의 canonical iframe을 표시합니다. 페이지네이션은 실행하지 않습니다.
