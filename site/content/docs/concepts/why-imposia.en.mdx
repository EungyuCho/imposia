...
If the first one describes your product, the next step is [Build your first page](/en/docs/getting-started). If you want to see how the single-document rule is actually enforced at runtime, read [The publishing model](/en/docs/concepts/publishing-model).
