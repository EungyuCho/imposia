...
The final command confirms that the build mutates no tracked files. The
browser example bundles are generated and untracked (ASA-448), so they never
appear in that diff. Inspect each package before publishing:
