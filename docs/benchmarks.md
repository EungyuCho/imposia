...
The benchmark uses pinned Chromium and verifies exact 10, 50, and 200-page A4 output for a deterministic local workload containing embedded font data, SVG images, tables, headings, and body text. It performs three cold renderer runs and seven warm renders after an unmeasured warm-up for each size.
