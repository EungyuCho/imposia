...
Status: superseded by [ADR 0004](0004-browser-first-page-dom.md) on 2026-07-18. Historical decision; still describes the implementation shipped at this commit.
...
This was the v1 decision for the legacy implementation. Its exported artifact is a PDF: `@imposia/core` produces Chromium PDF bytes and `@imposia/viewer` renders those bytes with PDF.js. The current package entrypoints and CLI still implement this decision.
