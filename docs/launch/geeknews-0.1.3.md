...
- Reviewed change set: [PR #12](https://github.com/EungyuCho/imposia/pull/12)
- Release candidate: `0.1.3`
- Public package family: `@imposia/core`, `@imposia/viewer`,
  `@imposia/client`, `@imposia/react`
- Full gate: [`CI=true pnpm check`](https://github.com/EungyuCho/imposia/pull/12/checks)
- Browser matrix: [354 passed, 120 intentional skips, 0 failed, 474 total](https://github.com/EungyuCho/imposia/pull/12/checks)
- Site matrix: [8 passed](https://github.com/EungyuCho/imposia/pull/12/checks)
- Unit/integration matrix: [23 passed](https://github.com/EungyuCho/imposia/pull/12/checks)
- Production dependency audit: [no known vulnerabilities](https://github.com/EungyuCho/imposia/pull/12/checks)
- License audit: [386 installed packages accepted by the reviewed policy](https://github.com/EungyuCho/imposia/pull/12/checks)
